      ...
      <div className="flex items-start gap-3 p-4 bg-white/[0.02] border border-white/5 rounded-xl max-w-4xl mx-auto">
        ...
        <div className="text-xs text-slate-400 leading-relaxed">
          ...
          <span className="block sm:hidden">
            ...
            <a 
              href="https://disneyspeedstorm.com/news/disney-speedstorm-new-racer-progression" 
              target="_blank" 
          ...
          {/* Desktop Only Text: Your exact full version */}
          <span className="hidden sm:block">
            <strong>Data Reference:</strong> The upgrade shard and currency costs displayed on this page 
            are sourced directly from the official racer progression data published by Gameloft. 
            For the full economy breakdown article, visit the{' '}
            <a 
              href="https://disneyspeedstorm.com/news/disney-speedstorm-new-racer-progression" 
              target="_blank" 
              rel="noopener noreferrer" 
            ...
            >
              Official Disney Speedstorm News Article
            </a>.
          </span>
        </div>
      </div>
